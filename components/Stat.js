                ...
                <div className="stats stats-vertical lg:stats-horizontal bg-primary text-primary-content m-2 w-11/12 lg:w-1/2">
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-actions">
                            <button className="btn btn-sm btn-secondary">Add Funds</button></div>
                    </div>
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-value">$89,400</div>
                        <div className="stat-actions">
                            <button className="btn btn-sm m-1">Withdrawal</button>
                            <button className="btn btn-sm m-1">deposit</button>
                        </div>
                    </div>
